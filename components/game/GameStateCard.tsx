      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="flex flex-col gap-3">
          ...
          <div className="mx-auto grid h-32 w-32 grid-cols-3 grid-rows-3 place-items-center">
            <div />
            <div className={`rotate-45 rounded p-5 ${bases?.second ? 'bg-yellow-400' : 'bg-slate-200 dark:bg-slate-700'}`} />
            <div />
            <div className={`rotate-45 rounded p-5 ${bases?.third ? 'bg-yellow-400' : 'bg-slate-200 dark:bg-slate-700'}`} />
            <div />
            <div className={`rotate-45 rounded p-5 ${bases?.first ? 'bg-yellow-400' : 'bg-slate-200 dark:bg-slate-700'}`} />
            <div />
          </div>
        </div>
